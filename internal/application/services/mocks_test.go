...
// Delete provides a mock function for the type mockapplication
func (_mock *mockapplication) Delete(ctx context.Context, key domain.Key) error {
	ret := _mock.Called(ctx, key)
...
//   - ctx
//   - key
func (_e *mockapplication_Expecter) Delete(ctx interface{}, key interface{}) *mockapplication_Delete_Call {
	return &mockapplication_Delete_Call{Call: _e.mock.On("Delete", ctx, key)}
}

func (_c *mockapplication_Delete_Call) Run(run func(ctx context.Context, key domain.Key)) *mockapplication_Delete_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(domain.Key))
	})
	return _c
...
func (_c *mockapplication_Delete_Call) Return(err error) *mockapplication_Delete_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *mockapplication_Delete_Call) RunAndReturn(run func(ctx context.Context, key domain.Key) error) *mockapplication_Delete_Call {
	_c.Call.Return(run)
	return _c
}

// Get provides a mock function for the type mockapplication
func (_mock *mockapplication) Get(ctx context.Context, key domain.Key) (*domain.Entry, error) {
	ret := _mock.Called(ctx, key)
...
//   - ctx
//   - key
func (_e *mockapplication_Expecter) Get(ctx interface{}, key interface{}) *mockapplication_Get_Call {
	return &mockapplication_Get_Call{Call: _e.mock.On("Get", ctx, key)}
}

func (_c *mockapplication_Get_Call) Run(run func(ctx context.Context, key domain.Key)) *mockapplication_Get_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(domain.Key))
	})
	return _c
...
func (_c *mockapplication_Get_Call) Return(entry *domain.Entry, err error) *mockapplication_Get_Call {
	_c.Call.Return(entry, err)
	return _c
}

func (_c *mockapplication_Get_Call) RunAndReturn(run func(ctx context.Context, key domain.Key) (*domain.Entry, error)) *mockapplication_Get_Call {
	_c.Call.Return(run)
	return _c
}

// Set provides a mock function for the type mockapplication
func (_mock *mockapplication) Set(ctx context.Context, key domain.Key, value domain.Value) error {
	ret := _mock.Called(ctx, key, value)
...
// mockapplication_Set_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Set'
type mockapplication_Set_Call struct {
	*mock.Call
}
...
//   - key
//   - value
func (_e *mockapplication_Expecter) Set(ctx interface{}, key interface{}, value interface{}) *mockapplication_Set_Call {
	return &mockapplication_Set_Call{Call: _e.mock.On("Set", ctx, key, value)}
}

func (_c *mockapplication_Set_Call) Run(run func(ctx context.Context, key domain.Key, value domain.Value)) *mockapplication_Set_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(domain.Key), args[2].(domain.Value))
	})
	return _c
...
func (_c *mockapplication_Set_Call) Return(err error) *mockapplication_Set_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *mockapplication_Set_Call) RunAndReturn(run func(ctx context.Context, key domain.Key, value domain.Value) error) *mockapplication_Set_Call {
	_c.Call.Return(run)
	return _c
}
