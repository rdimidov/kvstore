...
func TestCompute_Set(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			compute := NewCompute(mockRepo, zap.NewNop().Sugar())
			err := compute.Set(context.Background(), tt.args.key, tt.args.value)
			if tt.expectError {
				assert.Error(t, err)
			} else {
...
func TestCompute_Get(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			compute := NewCompute(mockRepo, zap.NewNop().Sugar())
			entry, err := compute.Get(context.Background(), tt.args.key)
			if tt.expectError {
				assert.Error(t, err)
			} else {
				assert.NoError(t, err)
...
func TestCompute_Delete(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			err := compute.Delete(context.Background(), tt.args.key)
			if tt.expectError {
				assert.Error(t, err)
			} else {
				assert.NoError(t, err)
